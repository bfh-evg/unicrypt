...
import ch.bfh.unicrypt.crypto.proofgenerator.classes.IdentityShuffleProofGenerator;
 ...
 * @author philipp
 */
public class IdentityShuffleProofGeneratorTest {
	...
	public void testIdentityShuffleProofGenerator() {
		...
		SigmaChallengeGenerator scg = IdentityShuffleProofGenerator.createNonInteractiveSigmaChallengeGenerator(G_q, G_q, size, 4, null, null);
		ChallengeGenerator ecg = IdentityShuffleProofGenerator.createNonInteractiveEValuesGenerator(G_q, G_q, size, 4, ro);
		IdentityShuffleProofGenerator spg = IdentityShuffleProofGenerator.getInstance(scg, ecg, G_q, size, G_q, 2, rrs);
	...
	public void testIdentityShuffleProofGenerator2() {
		...
		// Identity Shuffle Proof Generator
		IdentityShuffleProofGenerator spg = IdentityShuffleProofGenerator.getInstance(G_q, size, G_q, proverId, 60, 60, 20, rrs);
	...
	public void testIdentityShuffleProofGenerator3() {
		...
		// Identity Shuffle Proof Generator
		IdentityShuffleProofGenerator spg = IdentityShuffleProofGenerator.getInstance(G_qCom, size, G_q, proverId, 20, 20, 10, rrs);
