 ...
 */
public class ByteArrayFinalTest {

	private final ArrayList<ByteArrayFinal> byteArrayList = new ArrayList<ByteArrayFinal>();
	private final ArrayList<ByteString> byteStringList = new ArrayList<ByteString>();
	private final ByteArrayFinalToString converter = ByteArrayFinalToString.getInstance();

	private final byte BYTE_ZERO = (byte) 0L;
	private final byte BYTE_ONE = (byte) 0xFFL;

	public ByteArrayFinalTest() {
		...
		for (String string : stringList) {
			ByteArrayFinal ba = converter.reconvert(string);
	...
	public void test_constructor() {
		for (int i = 0; i < byteArrayList.size(); i++) {
			ByteArrayFinal ba = byteArrayList.get(i);
	...
	public void test_append() {
		for (int i = 0; i < byteArrayList.size(); i++) {
			ByteArrayFinal ba1 = byteArrayList.get(i);
			ByteString bs1 = byteStringList.get(i);
			for (int j = 0; j < byteArrayList.size(); j++) {
				ByteArrayFinal ba2 = byteArrayList.get(j);
	...
	public void performTest(ByteArrayFinal ba, ByteString bs) {
