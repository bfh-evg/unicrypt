...
public class MultiPedersenCommitmentSchemeOld extends AbstractRandomizedCommitmentScheme<ProductSet, ZMod, CyclicGroup, Element> implements MultiCommitmentScheme {

  private final int arity;
  private final ProductGroup messagesSpace;

  public MultiPedersenCommitmentSchemeOld(final DDHGroup ddhGroup, final int arity) {
    this(ddhGroup, arity, (Random) null);
  }

  public MultiPedersenCommitmentSchemeOld(final DDHGroup ddhGroup, final int arity, final Random random) {
    this(ddhGroup, MultiPedersenCommitmentSchemeOld.createGenerators(ddhGroup, arity, random), ddhGroup.getDefaultGenerator());
  }

  public MultiPedersenCommitmentSchemeOld(final DDHGroup ddhGroup, final List<Element> generators, final Element otherGenerator) {
