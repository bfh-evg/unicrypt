...
public class PedersenCommitmentScheme extends AbstractRandomizedCommitmentScheme<ZMod, ZMod, CyclicGroup, Element> {
  ...
  public static PedersenCommitmentScheme getInstance(final CyclicGroup cyclicGroup, Encoder encoder) {
    return PedersenCommitmentScheme.getInstance(cyclicGroup, (Random) null, encoder);
  }

  public static PedersenCommitmentScheme getInstance(final CyclicGroup cyclicGroup, final Random random) {
    return PedersenCommitmentScheme.getInstance(cyclicGroup, random, (Encoder) null);
  }

  public static PedersenCommitmentScheme getInstance(final CyclicGroup cyclicGroup, final Random random, Encoder encoder) {
    if (cyclicGroup == null) {
      throw new IllegalArgumentException();
    }
    return PedersenCommitmentScheme.getInstance(cyclicGroup.getDefaultGenerator(), cyclicGroup.getRandomGenerator(random), encoder);
  }

  public static PedersenCommitmentScheme getInstance(final Element generator, final Random random) {
    return PedersenCommitmentScheme.getInstance(generator, random, (Encoder) null);
  }

  public static PedersenCommitmentScheme getInstance(final Element generator, final Random random, Encoder encoder) {
    if (generator == null) {
      throw new IllegalArgumentException();
    }
    return PedersenCommitmentScheme.getInstance(generator, ((CyclicGroup) generator.getSet()).getRandomGenerator(random), encoder);
  }

  public static PedersenCommitmentScheme getInstance(final CyclicGroup cyclicGroup, final Element otherGenerator) {
    return PedersenCommitmentScheme.getInstance(cyclicGroup, otherGenerator, (Encoder) null);
  }

  public static PedersenCommitmentScheme getInstance(final CyclicGroup cyclicGroup, final Element otherGenerator, Encoder encoder) {
    if (cyclicGroup == null) {
      throw new IllegalArgumentException();
    }
    return PedersenCommitmentScheme.getInstance(cyclicGroup.getDefaultGenerator(), otherGenerator, encoder);
  }

  public static PedersenCommitmentScheme getInstance(final Element generator, final Element otherGenerator) {
    return PedersenCommitmentScheme.getInstance(generator, otherGenerator, (Encoder) null);
  }

  public static PedersenCommitmentScheme getInstance(final Element generator, final Element otherGenerator, Encoder encoder) {
