...
import static ch.bfh.unicrypt.crypto.proofgenerator.abstracts.AbstractShuffleProofGenerator.DEFAULT_KR;
 ...
 * @author philipp
 */
public class IdentityShuffleProofGenerator
	   extends AbstractShuffleProofGenerator {

	final private CyclicGroup identityGroup;

	private IdentityShuffleProofGenerator(SigmaChallengeGenerator sigmaChallengeGenerator, ChallengeGenerator eValuesGenerator,
	...
	// getInstance...
	//
	public static IdentityShuffleProofGenerator getInstance(CyclicGroup cyclicGroup, int size, CyclicGroup identityGroup) {
		return getInstance(
	...
	public static IdentityShuffleProofGenerator getInstance(Tuple independentGenerators, CyclicGroup identityGroup, Element proverId, int ke, int kc, int kr) {
	...
	public static IdentityShuffleProofGenerator getInstance(SigmaChallengeGenerator sigmaChallengeGenerator,
	...
	public static IdentityShuffleProofGenerator getInstance(SigmaChallengeGenerator sigmaChallengeGenerator,
		...
		return new IdentityShuffleProofGenerator(sigmaChallengeGenerator, eValuesGenerator, cyclicGroup, size, kr, independentGenerators, identityGroup);
	}
