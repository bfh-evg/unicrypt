...
public class PreimageProofGenerator
       extends ProofGeneratorAbstract
  ...
  public PreimageProofGenerator(final Function function) {
    this(function, PreimageProofGenerator.DEFAULT_HASH_ALGORITHM, PreimageProofGenerator.DEFAULT_CONCAT_ALGORITHM, PreimageProofGenerator.DEFAULT_MAPPER);
  }
