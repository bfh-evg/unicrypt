...
public class StandardPreimageProofGenerator<PRS extends SemiGroup, PRE extends Element, PUS extends SemiGroup, PUE extends Element, F extends Function>
	   extends AbstractPreimageProofGenerator<PRS, PRE, PUS, PUE, F> {

	private final F preimageProofFunction;
	private final HashMethod hashMethod;

	protected StandardPreimageProofGenerator(final F function, HashMethod hashMethod) {
