...
public class StringSequence
	...
	private StringSequence(String string, char separator) {
	...
	private StringSequence(String string, char separator, char escapeChar) {
		super(Sequence.UNKNOWN);
		this.string = string;
		this.separator = separator;
		this.nested = false;
	...
	private StringSequence(String string, char separator, char openingParentesis, char closingParenthesis) {
		super(Sequence.UNKNOWN);
		this.string = string;
		this.separator = separator;
		this.nested = true;
	...
	private StringSequence(String string, char separator, char openingParentesis, char closingParenthesis, char escapeChar) {
		super(Sequence.UNKNOWN);
		this.string = string;
		this.separator = separator;
		this.nested = true;
