 ...
 * instance of {@link HashMethod} provides therefore its own {@link ConvertMethod} object of type {@link ByteArray},
...
public class HashMethod
	...
	public static HashMethod getInstance(HashAlgorithm hashAlgorithm, Mode mode) {
		return HashMethod.getInstance(hashAlgorithm, ConvertMethod.<ByteArray>getInstance(), mode);
	}
