...
public abstract class AbstractAdditiveAtomicMonoid extends AbstractAtomicMonoid<AdditiveAtomicElement> implements AdditiveMonoid {
  ...
  @Override
  public AdditiveAtomicElement timesTwo(Element element) {
    return this.selfApply(element);
  }

  @Override
  public AdditiveAtomicElement sumOfProducts(Element[] elements, BigInteger[] amounts) {
