...
public class ECZModPrimeParameters
	...
	public static final ECZModPrimeParameters SECP160k1 = new ECZModPrimeParameters(
		   80,
	...
	public static final ECZModPrimeParameters SECP160r1 = new ECZModPrimeParameters(
		   80,
	...
	public static final ECZModPrimeParameters SECP160r2 = new ECZModPrimeParameters(
		   80,
		   "FFFFFFFFFFFFFFFFFFFFFFFFFFFFFFFEFFFFAC73",
	...
	public static final ECZModPrimeParameters SECP192k1 = new ECZModPrimeParameters(
		   96,
	...
	public static final ECZModPrimeParameters SECP192r1 = new ECZModPrimeParameters(
		   96,
	...
	public static final ECZModPrimeParameters SECP224k1 = new ECZModPrimeParameters(
		   112,
	...
	public static final ECZModPrimeParameters SECP224r1 = new ECZModPrimeParameters(
		   112,
	...
	public static final ECZModPrimeParameters SECP256k1 = new ECZModPrimeParameters(
		   128,
	...
	public static final ECZModPrimeParameters SECP256r1 = new ECZModPrimeParameters(
		   128,
	...
	public static final ECZModPrimeParameters SECP384r1 = new ECZModPrimeParameters(
		   192,
	...
	public static final ECZModPrimeParameters SECP521r1 = new ECZModPrimeParameters(
		   256,
	...
	private ECZModPrimeParameters(int securityLevel, int modulus, int a, int b, int gx, int gy, int subGroupOrder,
		...
		this.setCoefficient(this.finiteField.getElement(a), this.finiteField.getElement(b));
		this.setGenerator(this.finiteField.getElement(gx), this.finiteField.getElement(gy));
	}

//	public static void main(String[] args) {
//
//		for (ECZModElement element : ECZModPrime.getInstance(TEST23).getElements()) {
//			System.out.println(element);
//		}
//
//		ECZModPrime ec = ECZModPrime.getInstance(TEST23);
//		ZModPrime zMod = ec.getFiniteField();
//		int i = 0;
//		for (ZModElement e1 : zMod.getElements()) {
//			for (ZModElement e2 : zMod.getElements()) {
