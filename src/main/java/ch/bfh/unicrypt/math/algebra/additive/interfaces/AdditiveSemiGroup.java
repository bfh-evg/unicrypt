 ...
 * @version 2.0
 */
public interface AdditiveSemiGroup<E extends AdditiveElement> extends SemiGroup<E> {
   ...
   */
  public E add(Element element1, Element element2);
   ...
   */
  public E times(Element element, BigInteger amount);
   ...
   */
  public E times(Element element, Element amount);
   ...
   */
  public E times(Element element, int amount);
