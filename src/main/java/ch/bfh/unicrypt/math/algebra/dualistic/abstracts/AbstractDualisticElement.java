 ...
 * @author rolfhaenni
 */
public abstract class AbstractDualisticElement<S extends SemiRing, E extends DualisticElement> extends AbstractAdditiveElement<S, E> implements DualisticElement {
