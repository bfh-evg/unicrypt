...
public enum SEC2_ECZModParameters
	...
	secp112r1("db7c2abf62e35e668076bead208b",
			  ...
			  "1"),
	secp160r1("ffffffffffffffffffffffffffffffff7fffffff",
			  ...
			  "1"),
	secp192k1("fffffffffffffffffffffffffffffffffffffffeffffee37",
			  "0",
			  "3",
	...
	secp192r1("fffffffffffffffffffffffffffffffeffffffffffffffff",
			  ...
			  "1"),
	secp224k1("fffffffffffffffffffffffffffffffffffffffffffffffeffffe56d",
			  "0",
			  "5",
	...
	public ZModElement getA() {
		return getFiniteField().getElement(new BigInteger(this.a, 16));
	}

	@Override
	public ZModElement getB() {
		return getFiniteField().getElement(new BigInteger(this.b, 16));
	}

	@Override
	public ZModElement getGx() {
		return getFiniteField().getElement(new BigInteger(this.gx, 16));
	}

	@Override
	public ZModElement getGy() {
		return getFiniteField().getElement(new BigInteger(this.gy, 16));
	}
