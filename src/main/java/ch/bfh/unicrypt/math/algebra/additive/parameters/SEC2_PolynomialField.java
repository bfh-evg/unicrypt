...
public enum SEC2_PolynomialField
	...
	public PolynomialElement getA() {
		return this.getFiniteField().getElement(this.getPolynomial(this.a).getValue());
	}

	@Override
	public PolynomialElement getB() {
		return this.getFiniteField().getElement(this.getPolynomial(this.b).getValue());
	}

	@Override
	public PolynomialElement getGx() {
		return this.getFiniteField().getElement(this.getPolynomial(this.gx).getValue());
	}

	@Override
	public PolynomialElement getGy() {
		return this.getFiniteField().getElement(this.getPolynomial(this.gy).getValue());
	}
