...
/**
 * This is a helper class with some static methods for various mathematical
 * functions.
 * <p>
 * @author R. Haenni
 * @author R. E. Koenig
...
public final class MathUtil {
  ...
  /**
   * Returns the value obtained from applying the Euler totient function to an
   * integer {@literal value}.
   * <dt><b>Preconditions:</b></dt>
   * <dd>{@literal primeFactorSet} is the complete set of prime factors of
   * {@literal value}.</dd>
   * <p>
   * @param value          The input value
   * @param primeFactorSet The prime factors of {@literal value}
   * @return the result of applying the Euler totient function to
   *         {@literal value}
   * @throws IllegalArgumentException if {@literal value} is {@literal null},
   *                                  {@literal 0}, or negative
   * @throws IllegalArgumentException if {@literal primeFactorSet} is null or if
   *                                  {@literal primeFactorSet} contains
   *                                  {@literal null}
  ...
  /**
   * Tests if some given BigInteger values are all prime factors of another
   * BigInteger value. The given list of prime factors need not be complete.
   * <p>
   * @param value   The given value
   * @param factors A given array of potential prime factors
   * @return {@literal true} if all values are prime factors, {@literal false}
   *         otherwise
   */
   ...
   * @return {@literal true} if all values are prime numbers, {@literal false}
   *         otherwise
   */
   ...
   * @return {@literal true} if {@literal value} is prime, {@literal false}
   *         otherwise
   */
   ...
   * @return {@literal true} if {@literal value} is a save prime,
   ...
   * @return {@literal true} if all values are positive, {@literal false}
   *         otherwise
   */
   ...
   * @return {@literal true} if {@literal value} is positive, {@literal false}
   *         otherwise
   */
   ...
   * <p>
   * @param values A given array of potential positive numbers
   * @return {@literal true} is all values are positive, {@literal false}
   *         otherwise
   */
   ...
   * @throws IllegalArgumentException if {@literal values} is null or empty, or
   *                                  if it contains null
   */
  ...
  /**
   * Computes the elegant pairing function for two non-negative BigInteger
   * values.
   * <p>
   ...
   * @throws IllegalArgumentException if {@literal value1} or {@literal value2}
   *                                  is null or negative
   */
  ...
  /**
   * Computes the elegant pairing function for a given list of non-negative
   * BigInteger values. The order in which the binary pairing function is
   * applied is recursively from left to right.
   * <p>
   * @see <a href="http://szudzik.com/ElegantPairing.pdf">ElegantPairing.pdf</a>
   * @param values The given values
   * @return The result of applying the elegant pairing function
   * @throws IllegalArgumentException if {@literal values} is null
   * @throws IllegalArgumentException if {@literal values} contains null or
   *                                  negative value
   */
  ...
  /**
   * Computes the elegant pairing function for a given list of non-negative
   * BigInteger values. The size of the given input list is taken as an
  ...
  /**
   * Computes the inverse of the binary elegant pairing function for a given
   * non-negative BigInteger value.
   * <p>
   * @see <a href="http://szudzik.com/ElegantPairing.pdf">ElegantPairing.pdf</a>
   * @param value The input value
  ...
  /**
   * Computes the inverse of the n-ary elegant pairing function for a given
   * non-negative BigInteger value.
   * <p>
   * @see <a href="http://szudzik.com/ElegantPairing.pdf">ElegantPairing.pdf</a>
   * @param value The input value
  ...
  /**
   * Computes the inverse of the n-ary elegant pairing function for a given
   * non-negative BigInteger value, where the size is included as additional
   * input value.
   * <p>
   * @see <a href="http://szudzik.com/ElegantPairing.pdf">ElegantPairing.pdf</a>
   * @param value The input value
