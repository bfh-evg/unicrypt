...
/**
 * This is a helper class with some static methods for various functions for generating random values. It contains a
 * static pseudo random number generator (PNRG) object, which may serve as a default random generator in a large
 * project. The initial seeding of this PRNG might be slow due to system-wide entropy gathering.
 * <p>
 * @author R. Haenni
 * @author R. E. Koenig
 * @version 1.0
...
public final class RandomUtil {
	...
	/**
	 * This is a helper method to switch between the default pseudo random number generator and some random generator
	 * given as an optional argument. This method is called by several of this class' public methods.
	 * <p>
	 * @param randomGenerator Either {@literal null} or a given random generator
	 * @return {@literal random}, if {@literal random != null}, {@literal defaultRandomGenerator} otherwise
	 */
	...
	/**
	 * Uses the default random generator to create a random integer between 0 and {@literal maxValue} (inclusive)
	 * <p>
	...
	/**
	 * Uses the default random generator to create a random integer between {@literal minValue} (inclusive) and
	...
	/**
	 * Uses a given random generator to create a random integer between {@literal minValue} (inclusive) and
	 * {@literal maxValue} (inclusive)
	 * <p>
	 * @param minValue The minimal value
	 * @param maxValue The maximal value
	...
	/**
	 * Uses a given random generator to create a random integer between 0 and {@literal maxValue} (inclusive)
	 * <p>
	 * @param maxValue The maximal value
	 * @param random   The given random generator
	 * @return The random integer
	...
	public static int getRandomInteger() {
		return RandomUtil.getRandomInteger((Random) null);
	}

	public static int getRandomInteger(Random random) {
		return RandomUtil.getRandomInteger(Integer.MIN_VALUE, Integer.MAX_VALUE, random);
	}

	public static byte getRandomByte() {
		return RandomUtil.getRandomByte((Random) null);
	}

	public static byte getRandomByte(Random random) {
		return (byte) RandomUtil.getRandomInteger(Byte.MIN_VALUE, Byte.MAX_VALUE, random);
	}
	...
	/**
	 * Uses the default random generator to create a random BigInteger value between 0 and {@literal maxValue} (inclusive)
	 * <p>
	 * @param maxValue The maximal value
	 * @return The random BigInteger value
	...
	/**
	 * Uses a given random generator to create a random BigInteger between 0 and {@literal maxValue} (inclusive)
	 * <p>
	 * @param maxValue The maximal value
	 * @param random   The given random generator
	 * @return The random BigInteger value
	...
	/**
	 * Uses the default random generator to create a random BigInteger value between {@literal minValue} (inclusive) and
	 * {@literal maxValue} (inclusive)
	 * <p>
	 * @param minValue The minimal value
	 * @param maxValue The maximal value
	...
	/**
	 * Uses a given random generator to create a random BigInteger value between {@literal minValue} (inclusive) and
	 * {@literal maxValue} (inclusive)
	 * <p>
	 * @param minValue The minimal value
	 * @param maxValue The maximal value
	...
	/**
	 * Uses the default random generator to create a random BigInteger value of a certain bit length that is probably
	 * prime with high certainty
	 * <p>
	 * @param bitLength The given bit length
	...
	/**
	 * Uses a given random generator to create a random BigInteger value of a certain bit length that is probably prime
	 * with high certainty
	 * <p>
	 * @param bitLength The given bit length
	 * @param random    The given random generator
	...
	/**
	 * Uses the default random generator to create a random BigInteger value of a certain bit length that is a save prime
	 * with high certainty
	 * <p>
	 * @param bitLength The given bit length
	...
	/**
	 * Uses a given random generator to create a random BigInteger value of a certain bit length that is a save prime with
	 * high certainty
	 * <p>
	 * @param bitLength The given bit length
	 * @param random    The given random generator
	...
	/**
	 * Uses the default random generator to create a pair of distinct random BigInteger values of respective bit lengths
	 * such that both values are probably prime with high certainty and such that the second divides the first minus one.
	 * <p>
	...
	/**
	 * Uses a given random generator to create a pair of distinct random BigInteger values of respective bit lengths such
	 * that both values are probably prime with high certainty and such that the second divides the first minus one.
	 * <p>
	 * @param bitLength1 The bit length of the first random prime
	 * @param bitLength2 The bit length of the second random prime
	 * @param random     The given random generator
