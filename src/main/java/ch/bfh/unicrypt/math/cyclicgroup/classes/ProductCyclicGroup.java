...
import ch.bfh.unicrypt.math.cyclicgroup.abstracts.AbstractProductCyclicGroup;
 ...
 * @author rolfhaenni
 */
public class ProductCyclicGroup extends AbstractProductCyclicGroup<CyclicGroup> {
