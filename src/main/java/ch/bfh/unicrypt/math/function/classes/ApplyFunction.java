...
public class ApplyFunction
	   extends AbstractFunction<ProductSemiGroup, SemiGroup, Element> {
	...
	/**
	 * This is a special factory method for this class for the particular case
	 * of two input elements of a given group.
	 * <p/>
	 * @param semiGroup
