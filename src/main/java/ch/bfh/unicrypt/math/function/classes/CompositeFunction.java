 ...
 * consists of multiple internal functions f_i:X_i->Y_i, which are applied
 * sequentially to the input element in the given order. For this to work,
 * X_i=Y_{i-1} must hold for i=2,...,n, i.e., the co-domain of the first
 * function must correspond to the domain of the second function, the co-domain
 * of the second function must correspond to the domain of the third function,
 * and so on.
 *
 * @author R. Haenni
 * @author R. E. Koenig
